...
<div class="space-y-10">
	...
	<ol class="space-y-8">
		<li class="flex gap-4">
			<span
				class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-indigo-600/20 font-mono text-xs text-indigo-400"
				>1</span
			>
			<div class="min-w-0 flex-1">
				<p class="font-medium text-gray-200">Browse the registry</p>
				<p class="mt-1 text-sm text-gray-500">
					Find an extension on the <a href="/" class="text-indigo-400 hover:text-indigo-300"
						>Browse</a
		...
		<li class="flex gap-4">
			...
			<div class="min-w-0 flex-1">
				<p class="font-medium text-gray-200">
					Paste it into <code
						class="rounded bg-bg-secondary px-1 py-0.5 font-mono text-xs text-gray-300"
						>providers.yaml</code
					>
				</p>
				<p class="mt-1 text-sm text-gray-500">
					...
					your Dockerfile. See the <a
						...
						class="text-indigo-400 hover:text-indigo-300">Configuration</a
		...
		<li class="flex gap-4">
			...
			<div class="min-w-0 flex-1">
				...
				<p class="mt-1 text-sm text-gray-500">
					Run <code class="font-mono text-xs text-gray-400">docker build .</code> and the extensions
