...
<div class="space-y-12">
	<div>
		...
		<p class="text-base leading-relaxed text-gray-400">
			Reference for <code
				class="rounded bg-bg-secondary px-1.5 py-0.5 font-mono text-sm text-gray-300"
				>providers.yaml</code
			>
			...
			<table class="w-full text-sm">
				...
				<tbody class="divide-y divide-border text-gray-400">
					...
					<tr>
						...
						<td class="px-4 py-3 text-xs">Yes</td>
						<td class="px-4 py-3 text-xs"
							>The exact version to download (e.g. <code class="font-mono text-gray-500"
								>v26.1.1</code
	...
	<section>
		...
		<ul class="space-y-4 text-sm">
			<li class="flex gap-3">
				<code
					class="mt-0.5 shrink-0 rounded bg-bg-secondary px-1.5 py-0.5 font-mono text-xs text-indigo-300"
					>name</code
				>
				<p class="text-gray-400">
					The extension slug, visible at the end of the extension URL:
					<code class="rounded bg-bg-secondary px-1 py-0.5 font-mono text-xs text-gray-300"
						>/extension/<em>keycloak-home-idp-discovery</em></code
					>. Use the <a href="/" class="text-indigo-400 hover:text-indigo-300">Browse</a> page to find
					extensions.
				</p>
			</li>
			<li class="flex gap-3">
